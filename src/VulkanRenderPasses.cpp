...
VulkanRenderPasses::~VulkanRenderPasses() {
    vkDestroyRenderPass(vulkanDevice.device, mainRenderPass, nullptr);
    vkDestroyRenderPass(vulkanDevice.device, shadowsRenderPass, nullptr);
}
...
void VulkanRenderPasses::createMainRenderPass() {
    ...
    if (vkCreateRenderPass(vulkanDevice.device, &renderPassInfo, nullptr, &mainRenderPass) != VK_SUCCESS) {
        throw std::runtime_error("failed to create render pass!");
    }
}

void VulkanRenderPasses::createShadowsRenderPass() {
    
    VkAttachmentDescription depthAttachment = {};
    depthAttachment.format = SHADOWS_DEPTH_FORMAT;
    ...
    if (vkCreateRenderPass(vulkanDevice.device, &renderPassInfo, nullptr, &shadowsRenderPass) != VK_SUCCESS) {
        throw std::runtime_error("failed to create render pass!");
    }
}
